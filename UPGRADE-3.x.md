...
Defining menu blocks by using the `<tag name="sonata.block.menu"/>` was removed, because it never worked properly.

Use the normal <tag name="knp_menu.menu" alias="sonata.main" /> tag to define a menu block.
